...
import { featureSchema, multiPolygonSchema, polygonSchema, rasterProductTypeSchema, resourceIdSchema } from '../core';
...
export const aggregationFeature = featureSchema(polygonSchema.or(multiPolygonSchema).or(z.null()), aggregationFeaturePropertiesSchema).describe(
  'aggregationFeature'
);
